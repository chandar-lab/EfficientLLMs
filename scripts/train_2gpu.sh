...
torchrun --nproc_per_node=2 src/main.py --configs 'configs/base.jsonnet, configs/model/gp2-small.jsonnet, configs/dataset/openwebtext.jsonnet, configs/trainer/gpt2_2gpu_ddp.jsonnet, configs/quantization/g4_sym_per_column.jsonnet' train
#srun \
